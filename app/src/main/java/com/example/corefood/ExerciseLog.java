...
public class ExerciseLog {
    ...
    private String EL_USER, EL_EXERCISE_TYPE, El_INTENSITY, EL_DURATION_MINS, EL_CALORIES_BURNED, EL_TIME, EL_NOTES;
    ...
    public ExerciseLog(String COL_USER, String COL_EXERCISE_TYPE, String COL_INTENSITY, String COL_DURATION_MINS, String COL_CALORIES_BURNED, String COL_TIME, String COL_NOTES) {
        this.EL_USER = COL_USER;
    ...
    public String getEL_USER() { return EL_USER; }
    ...
    public void setEL_USER(String EL_USER) { this.EL_USER = EL_USER; }
